    ...
    <div class="container">
        <div class="row">
            <div class="card" style="width: 18rem;">
              ...
              <div class="card" style="width: 18rem;">
                <div class="card-header">
                    <img src="image/Digital marketingAsset 5 1.png" class="card-img-top" alt="...">
                </div>
                <div class="card-body">
              ...
              <div class="card" style="width: 18rem;">
                <div class="card-header">
                    <img src="image/graphic designAsset 2 1.png" class="card-img-top" alt="...">
                </div>
                <div class="card-body">
              ...
              <div class="card" style="width: 18rem;">
                <div class="card-header">
                    <img src="image/software developmentAsset 1 1.png" class="card-img-top" alt="...">
                </div>
                <div class="card-body">
