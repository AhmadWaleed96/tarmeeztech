                    ...
                    <li><a href="widgets.html"><i class="fa-solid fa-gauge-high"></i><span>{{ __('site.Dashbord') }}</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="media_gallery.html">> <span>{{ __('site.All Service') }}</span></a></li>
                           <li><a href="icons.html">> <span>{{ __('site.Add Service') }}</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="works">
                           <li><a href="email.html">> <span>{{ __('site.All Work') }}</span></a></li>
                           <li><a href="calendar.html">> <span>{{ __('site.Add Work') }}</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="imags">
                           <li><a href="email.html">> <span>{{ __('site.All Image') }}</span></a></li>
                           <li><a href="calendar.html">> <span>{{ __('site.Add Image') }}</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="blogs">
                           <li><a href="email.html">> <span>{{ __('site.All Blog') }}</span></a></li>
                           <li><a href="calendar.html">> <span>{{ __('site.Add Blog') }}</span></a></li>
                           <li><a href="media_gallery.html">> <span>{{ __('site.Trashed Blog') }}</span></a></li>
                        </ul>
                     </li>
                     <li>
                        <a href="#howdo" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa-solid fa-dove"></i><span>{{ __('site.How Do') }}</span></a>
                        <ul class="collapse list-unstyled" id="howdo">
                           <li><a href="email.html">> <span>{{ __('site.All How Do') }}</span></a></li>
                           <li><a href="calendar.html">> <span>{{ __('site.Add How Do') }}</span></a></li>
                           <li><a href="media_gallery.html">> <span>{{ __('site.Trashed How Do') }}</span></a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="jops">
                           <li><a href="email.html">> <span>{{ __('site.All Jop') }}</span></a></li>
                           <li><a href="calendar.html">> <span>{{ __('site.Add Jop') }}</span></a></li>
                           <li><a href="media_gallery.html">> <span>{{ __('site.Trashed Jop') }}</span></a></li>
                        </ul>
                     </li>
                     <li><a href="map.html"><i class="fa-solid fa-calendar-check"></i> <span>{{ __('site.Booking') }}</span></a></li>
                     <li><a href="charts.html"><i class="fa-solid fa-file-signature"></i><span>{{ __('site.Contact') }}</span></a></li>
                     <li><a href="settings.html"><i class="fa-solid fa-person-walking-luggage"></i> <span>{{ __('site.Employment') }}</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
                                 ...
                                 <li>
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      @endforeach
                                       ...
                                       <a class="dropdown-item" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit()"><span>{{ __('site.Log Out') }}</span> <i class="fa fa-sign-out"></i></a>
